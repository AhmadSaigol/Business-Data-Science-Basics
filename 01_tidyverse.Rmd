...
bike_orderlines_wrangled_tbl %>%
  write_xlsx("00_data/01_raw_data/01_bike_sales/02_wrangled_data/bike_orderlines_challenge.xlsx")
```
### CSV
```{r}
bike_orderlines_wrangled_tbl %>% 
  write_csv("00_data/01_raw_data/01_bike_sales/02_wrangled_data/bike_orderlines_challenge.csv")
```
### RDS
```{r}
bike_orderlines_wrangled_tbl %>% 
  write_rds("00_data/01_raw_data/01_bike_sales/02_wrangled_data/bike_orderlines_challenge.rds")
```
